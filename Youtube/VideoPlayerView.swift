...
class VideoPlayerView: UIView {
    ...
    func setupFrame(urlString:String) {
        ...
        controlsContainerView.frame = frameSize
    ...
    func changeVideoSize(frame:CGRect) {
        self.frame = frame
...
class VideoLauncher: NSObject {
    ...
    func showVideoPlayer() -> VideoPlayerView? {
